...
const sidebarItems = [
  ...
  { id: 'cashiers', label: 'Caissiers & Magasiniers', icon: Users },
  { id: 'users', label: 'Gestion Système', icon: ShieldCheck },
...
const CEODashboard = () => {
  ...
  const titles = { 
    ...
    users: 'Gestion du Personnel (Système)',
  ...
  const subtitles = { 
    ...
    cashiers: 'Supervisez les caissiers et magasiniers du magasin actuel',
    users: 'Création et gestion des comptes utilisateurs du système (Managers, Comptables, etc.)',
    settings: 'Informations globales affichées sur les factures et reçus'
  };
