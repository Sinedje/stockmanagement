...
import { UserOutlined, CheckCircleOutlined, FileTextOutlined, GlobalOutlined, NumberOutlined, PhoneOutlined, SettingOutlined, ShopOutlined } from '@ant-design/icons';
...
const CompanySettings = () => {
  ...
  // Deux onglets : ce qui appartient à la personne, et ce qui appartient à
  // l'entreprise. Les mélanger sur une seule page obligeait à faire défiler
  // tout le formulaire commercial pour atteindre son propre mot de passe.
  const tabs = [
    {
      key: 'account',
    ...
    {
      key: 'company',
      label: <span className="flex items-center gap-1.5"><ShopOutlined /> {t('s.entreprise')}</span>,
      children: (
